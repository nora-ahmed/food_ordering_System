...
class Cart {
    ...
    public void addItem(CartItem item) {
        ...
        for (CartItem existingItem : this.items) {
            if (existingItem.getDish().getName().equalsIgnoreCase(item.getDish().getName())) {
                System.out.println("Item " + item.getDish().getName() + " is already in the cart.");

                return; // Exit the method without adding the item to the cart again
            }
        }

        // If the item is not already in the cart, proceed with adding it
        // Ask the user for the quantity
        System.out.println("Enter the quantity for '" + item.getDish().getName() + "': ");
        ...
        try {
            ...
            return; // Don't add the item to the cart if the input is not an integer
        }
        ...
        if (response.equalsIgnoreCase("yes")) {
            ...
            do {
                ...
                try {
                    ...
                    System.out.println("Invalid input. Please enter a valid integer for the customization.");
                    scanner.next(); // Clear the invalid input
    ...
    public double getTotalPrice() {
        ...
        for (CartItem item : this.items) {
            totalPrice += item.getTotalPriceWithCustomizations();
        }
